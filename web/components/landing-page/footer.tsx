...
const Footer = () => {
  return (
    <div className="bg-black text-white font-sans">
          ...
          <div className="max-w-[1200px] mx-auto px-8 md:px-16 flex flex-col gap-12 pt-12 pb-12 md:flex-row md:justify-between md:pt-16 md:pb-[120px]">
            ...
            <div className="flex gap-[60px] md:gap-[120px]">
              ...
              <div>
                ...
                <a href="/partners" className="block text-[#6b6b6b] no-underline text-sm mb-4 hover:text-white transition-colors duration-200">Partners</a>
      ...
      <div className=''>
        <div className="h-[20rem] lg:h-[20rem] hidden md:flex items-center justify-center w-full max-w-screen-lg mx-auto">
